    ...
    if (!args[0]) {
      if (language === 'fr') {
        ...
        const embed = new EmbedBuilder()
          .setDescription(`[**Page d'aide de InvitesCounter (beta)**](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=24)\nPrefix: \`=\`\n\n`)
          .addFields([
            {
              name: '⚙️・ Admin:',
              value: `${admincmd}\n`
          ...
          .addFields([
            {
              name: ' ',
              value: `[\`Cliquez ici pour utiliser le bot !\`](https://discord.gg/YWYXbFyXsY) [\`Cliquez ici pour ajouter le bot\`](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=24)`
            }
          ])
          .setColor('Green')
          .setFooter({ text: '©️ InvitesCounter (beta)' })
        ...
        const embed = new EmbedBuilder()
          .setDescription(`[**InvitesCounter (beta)'s help page**](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=24)\nPrefix: \`=\`\n\n`)
          .addFields([
            {
              name: '⚙️・ Admin:',
              value: `${admincmd}\n`
          ...
          .addFields([
            {
              name: ' ',
              value: `[\`Click here to use the bot !\`](https://discord.gg/YWYXbFyXsY) [\`Click here to add the bot\`](https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=24)`
            }
          ])
          .setColor('Green')
          .setFooter({ text: '©️ InvitesCounter (beta)' })
